...
public:
    explicit EndOfSequence(const std::string& msg = "End of sequence reached")
        : LabException(msg) {}
};
...
public:
    explicit EmptySequence(const std::string& msg = "Sequence is empty")
        : LabException(msg) {}
};
...
public:
    explicit InfiniteSequence(const std::string& msg = "Operation not supported on infinite sequence")
        : LabException(msg) {}
};